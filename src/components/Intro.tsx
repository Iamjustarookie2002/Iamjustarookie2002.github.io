        ...
        <div className="w-full">
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-12">
            ...
            <div className="flex-10 text-center lg:text-right max-w-2xl lg:ml-auto lg:mr-8">
              <h1 className="font-bold text-[var(--primary)] mb-4 relative pb-2 whitespace-nowrap static-hero-name">
                {introData.name}
              </h1>
              <div className="mt-4">
                <p className="text-lg md:text-xl text-[var(--text-main)] mb-6">
                  {introData.summary}
                </p>
                <div className="flex justify-center space-x-6 mb-4">
                  <a href={introData.github} target="_blank" rel="noopener noreferrer"
                    className="p-3 intro-icon backdrop-blur-sm rounded-full transition-all duration-300 hover:scale-110">
                ...
                {onJourneyClick && (
                  <div className="flex justify-center mt-6">
                    <button
                      ...
                      className="text-[var(--primary)] hover:text-[white] font-semibold text-lg transition-colors duration-300 hover:scale-105 transform"
                    >
            ...
            <div className="flex-2 flex justify-center lg:justify-end lg:mr-8">
              <div className="relative profile-img-container">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-[color:var(--primary)]/30 to-transparent rounded-full blur-xl -z-10 w-full h-full"></div>
              </div>
            </div>
          </div>
        </div>
