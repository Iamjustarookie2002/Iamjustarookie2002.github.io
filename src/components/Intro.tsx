...
const Intro: React.FC<IntroProps> = ({ fromJourney }) => {
  ...
  return (
    <section id="anime" className="relative z-10 text-center w-full px-[5%] min-h-screen flex flex-col justify-center items-center intro-section-bg overflow-x-auto">
      ...
      {showStaticHero && (
        <div className="w-full text-center py-16 flex flex-col justify-center items-center intro-section-transparent-bg">
          <h1
            className="font-bold text-white mb-4 relative pb-2 whitespace-nowrap static-hero-name"
          >
            Rishikesh Kudikala
          </h1>
          <div className="mt-4 max-w-2xl mx-auto">
                ...
                <a href="mailto:rkudikal@purdue.edu"
                  className="p-3 bg-white/10 backdrop-blur-sm rounded-full hover:bg-white/20 transition-all duration-300 hover:scale-110">
                  <svg className="h-6 w-6 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" d="M16 12H8m8 0a4 4 0 11-8 0 4 4 0 018 0zm-8 0V8a4 4 0 018 0v4" /></svg>
                </a>
              </div>
          </div>
        </div>
