        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-[#7cb6fe] transition-colors">
                  {project.title}
                </h3>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.technologies.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className="px-3 py-1 text-[#7cb6fe] text-xs rounded-full border border-[#7cb6fe] bg-black/40"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="flex space-x-3">
                  {project.link && (
                    <a
                      ...
                      className="flex items-center space-x-2 px-4 py-2 rounded-lg global-hover-btn text-white text-sm transition-colors"
                    >
                  ...
                  {project.github && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center space-x-2 px-4 py-2 rounded-lg global-hover-btn text-white text-sm transition-colors border border-[#7cb6fe] hover:bg-[#7cb6fe] hover:text-black"
                    >
                      <Github className="h-4 w-4 text-[#7cb6fe]" />
                      <span>Code</span>
                    </a>
                  )}
                </div>
